import 'package:restaurant/page/cart.dart';
import 'package:flutter/material.dart'; 
import 'package:restaurant/model/daftar_menu.dart';
import 'package:restaurant/page/detail.dart';
import 'package:restaurant/widget/pesan_button.dart';
      ...
      body: LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
          if (constraints.maxWidth <= 650) {
            ...
            return const DaftarMenuGrid(gridCount: 4);
          } else {
            return const DaftarMenuGrid(gridCount: 6);
          }
        },
      ),
    );
...
class DaftarMenuGrid extends StatelessWidget {
  final int gridCount; 
  const DaftarMenuGrid({super.key, required this.gridCount});
